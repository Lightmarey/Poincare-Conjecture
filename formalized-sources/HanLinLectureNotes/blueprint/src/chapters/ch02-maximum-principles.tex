...
\begin{lemma}[Weak maximum principle]\label{hanlin:maxprin-lemma-2-3}\dcref{Lemma 2.3}\group{ch02-maximum-principles}\source{han-lin-lecture-notes:page-0029}
...
\begin{theorem}[Hopf lemma]\label{hanlin:maxprin-theorem-2-6}\dcref{Theorem 2.6}\group{ch02-maximum-principles}\source{han-lin-lecture-notes:page-0030,han-lin-lecture-notes:page-0031}
...
\begin{theorem}[Strong maximum principle]\label{hanlin:maxprin-theorem-2-8}\dcref{Theorem 2.8}\group{ch02-maximum-principles}\source{han-lin-lecture-notes:page-0031}
Let $u\in C^2(\Omega)\cap C(\overline\Omega)$ satisfy $Lu\ge0$ and $c\le0$ in
...
\begin{corollary}[Comparison principle]\label{hanlin:maxprin-cor-2-9}\dcref{Corollary 2.9}\group{ch02-maximum-principles}\source{han-lin-lecture-notes:page-0032}
...
\begin{proposition}[Maximum principle on narrow domains]\label{hanlin:maxprin-prop-2-15}\dcref{Proposition 2.15}\group{ch02-maximum-principles}\source{han-lin-lecture-notes:page-0033,han-lin-lecture-notes:page-0034}
...
\begin{theorem}[Alexandroff maximum principle]\label{hanlin:maxprin-theorem-2-30}\dcref{Theorem 2.30}\group{ch02-maximum-principles}\source{han-lin-lecture-notes:page-0049,han-lin-lecture-notes:page-0050,han-lin-lecture-notes:page-0051}
