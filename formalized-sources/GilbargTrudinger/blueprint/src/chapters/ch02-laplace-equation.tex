...
\begin{theorem}[Mean value theorem]\label{gt.thm2.1}\dcref{ch2:2.1}\group{chapter-2}\source{gilbarg-trudinger:page-0026}
...
\begin{theorem}[Strong maximum principle]\label{gt.thm2.2}\dcref{ch2:2.2}\group{chapter-2}\source{gilbarg-trudinger:page-0027}
...
\begin{theorem}[Weak maximum principle]\label{gt.thm2.3}\dcref{ch2:2.3}\group{chapter-2}\source{gilbarg-trudinger:page-0027}
...
\begin{theorem}[Dirichlet uniqueness]\label{gt.thm2.4}\dcref{ch2:2.4}\group{chapter-2}\source{gilbarg-trudinger:page-0027}
...
\begin{theorem}[Harnack inequality]\label{gt.thm2.5}\dcref{ch2:2.5}\group{chapter-2}\source{gilbarg-trudinger:page-0028}
...
\begin{theorem}[Dirichlet problem on a ball]\label{gt.thm2.6}\dcref{ch2:2.6}\group{chapter-2}\source{gilbarg-trudinger:page-0032}
...
\begin{theorem}[Mean value characterization]\label{gt.thm2.7}\dcref{ch2:2.7}\group{chapter-2}\source{gilbarg-trudinger:page-0033}
...
\begin{theorem}\label{gt.thm2.8}\dcref{ch2:2.8}\group{chapter-2}\source{gilbarg-trudinger:page-0033}
...
\begin{theorem}[Harnack convergence theorem]\label{gt.thm2.9}\dcref{ch2:2.9}\group{chapter-2}\source{gilbarg-trudinger:page-0034}
...
\begin{theorem}[Perron solution]\label{gt.thm2.12}\dcref{ch2:2.12}\group{chapter-2}\source{gilbarg-trudinger:page-0036}
The function
...
\begin{lemma}\label{gt.lem2.13}\dcref{ch2:2.13}\group{chapter-2}\source{gilbarg-trudinger:page-0037}
...
\begin{theorem}[Dirichlet solvability and regularity]\label{gt.thm2.14}\dcref{ch2:2.14}\group{chapter-2}\source{gilbarg-trudinger:page-0038}
