...
\begin{definition}\label{gt.def5.1.contraction-mapping}\dcref{ch5:contraction-mapping}\group{chapter-5}\source{gilbarg-trudinger:page-0086}
A map $T$ on a normed linear space $\V$ is a contraction if some $\theta<1$
satisfies
\dcref{ch5:5.1}\group{chapter-5}\source{gilbarg-trudinger:page-0086}
\begin{equation}\label{gt.eq5.1}
\|Tx-Ty\|\leq\theta\|x-y\| \qquad (x,y\in\V).
\end{equation}
\end{definition}

\begin{theorem}[Contraction mapping principle]\label{gt.thm5.1}\dcref{ch5:5.1}\group{chapter-5}\source{gilbarg-trudinger:page-0086}
...
\begin{definition}\label{gt.def5.2.bounded-linear-operator}\dcref{ch5:bounded-linear-mapping}\group{chapter-5}\source{gilbarg-trudinger:page-0086,page-0087}
A linear map $T:\V_1\to\V_2$ is bounded when
\dcref{ch5:5.2}\group{chapter-5}\source{gilbarg-trudinger:page-0087}
...
\begin{theorem}[Method of continuity]\label{gt.thm5.2}\dcref{ch5:5.2}\group{chapter-5}\source{gilbarg-trudinger:page-0087}
Let $\B$ be Banach, let $\V$ be normed, and let
$L_t=(1-t)L_0+tL_1:\B\to\V$ be bounded and linear. If one constant $C$
satisfies
\dcref{ch5:5.3}\group{chapter-5}\source{gilbarg-trudinger:page-0087}
...
\begin{definition}\label{gt.def5.3.compact-mapping}\dcref{ch5:compact}\group{chapter-5}\source{gilbarg-trudinger:page-0087,page-0088}
...
\begin{theorem}[Fredholm alternative]\label{gt.thm5.3}\dcref{ch5:5.3}\group{chapter-5}\source{gilbarg-trudinger:page-0088,page-0089,page-0090}
...
\begin{lemma}[Almost orthogonal vectors]\label{gt.lem5.4}\dcref{ch5:5.4}\group{chapter-5}\source{gilbarg-trudinger:page-0088}
...
\begin{definition}\label{gt.def5.3.eigenvalue}\dcref{ch5:eigenvalue}\group{chapter-5}\source{gilbarg-trudinger:page-0090}
...
\begin{theorem}[Spectrum of a compact operator]\label{gt.thm5.5}\dcref{ch5:5.5}\group{chapter-5}\source{gilbarg-trudinger:page-0090,page-0091}
...
\begin{definition}\label{gt.def5.4.dual-space}\dcref{ch5:dual-space}\group{chapter-5}\source{gilbarg-trudinger:page-0091}
The dual $\V^*$ of a normed space $\V$ is the Banach space of bounded linear
functionals with norm
\dcref{ch5:5.5}\group{chapter-5}\source{gilbarg-trudinger:page-0091}
\begin{equation}\label{gt.eq5.5}
\|f\|_{\V^*}=\sup_{x\neq0}\frac{|f(x)|}{\|x\|}.
\end{equation}
\end{definition}

\begin{definition}\label{gt.def5.4.reflexive}\dcref{ch5:reflexive}\group{chapter-5}\source{gilbarg-trudinger:page-0091}
The canonical map $J:\V\to\V^{**}$ is defined by $Jx(f)=f(x)$. It is a
linear isometry, and $\V$ is reflexive when $J(\V)=\V^{**}$.
\end{definition}

\begin{definition}\label{gt.def5.4.adjoint}\dcref{ch5:adjoint}\group{chapter-5}\source{gilbarg-trudinger:page-0091}
For a bounded linear map $T:\B_1\to\B_2$, its adjoint
$T^*:\B_2^*\to\B_1^*$ is defined by
\dcref{ch5:5.6}\group{chapter-5}\source{gilbarg-trudinger:page-0091}
...
\begin{definition}\label{gt.def5.5.inner-product}\dcref{ch5:inner-product}\group{chapter-5}\source{gilbarg-trudinger:page-0092}
An inner product on a real vector space $\V$ is a symmetric bilinear form
$(\cdot,\cdot)$ with $(x,x)>0$ for $x\neq0$. It induces
$\|x\|=(x,x)^{1/2}$ and satisfies
\dcref{ch5:5.7}\group{chapter-5}\source{gilbarg-trudinger:page-0092}
\begin{equation}\label{gt.eq5.7}
|(x,y)|\leq\|x\|\,\|y\|,
\end{equation}
\dcref{ch5:5.8}\group{chapter-5}\source{gilbarg-trudinger:page-0092}
\begin{equation}\label{gt.eq5.8}
\|x+y\|\leq\|x\|+\|y\|,
\end{equation}
and
\dcref{ch5:5.9}\group{chapter-5}\source{gilbarg-trudinger:page-0092}
\begin{equation}\label{gt.eq5.9}
\|x+y\|^2+\|x-y\|^2=2(\|x\|^2+\|y\|^2).
\end{equation}
\end{definition}

\begin{definition}\label{gt.def5.5.hilbert-space}\dcref{ch5:hilbert-space}\group{chapter-5}\source{gilbarg-trudinger:page-0092}
A Hilbert space is a complete inner-product space.
\end{definition}

\section*{5.6. The Projection Theorem}

\begin{definition}\label{gt.def5.6.orthogonal}\dcref{ch5:orthogonal}\group{chapter-5}\source{gilbarg-trudinger:page-0093}
Vectors $x,y$ are orthogonal when $(x,y)=0$. For $\M\subset\Hspace$, set
$\M^\perp=\{x:(x,y)=0\text{ for every }y\in\M\}$.
\end{definition}

\begin{theorem}[Projection theorem]\label{gt.thm5.6}\dcref{ch5:5.6}\group{chapter-5}\source{gilbarg-trudinger:page-0093}
...
\begin{theorem}[Riesz representation]\label{gt.thm5.7}\dcref{ch5:5.7}\group{chapter-5}\source{gilbarg-trudinger:page-0094}
...
\begin{definition}\label{gt.def5.8.bilinear}\dcref{ch5:bounded-coercive-bilinear-form}\group{chapter-5}\source{gilbarg-trudinger:page-0095}
A bilinear form $\mathbf B$ on $\Hilb$ is bounded if some $K$ satisfies
\dcref{ch5:5.10}\group{chapter-5}\source{gilbarg-trudinger:page-0095}
\begin{equation}\label{gt.eq5.10}
|\mathbf B(x,y)|\leq K\|x\|\,\|y\|,
\end{equation}
and coercive if some $\nu>0$ satisfies
\dcref{ch5:5.11}\group{chapter-5}\source{gilbarg-trudinger:page-0095}
\begin{equation}\label{gt.eq5.11}
\mathbf B(x,x)\geq\nu\|x\|^2.
\end{equation}
\end{definition}

\begin{theorem}[Lax--Milgram]\label{gt.thm5.8}\dcref{ch5:5.8}\group{chapter-5}\source{gilbarg-trudinger:page-0095}
...
\begin{definition}\label{gt.def5.9.adjoint-hilbert}\dcref{ch5:adjoint-in-a-hilbert-space}\group{chapter-5}\source{gilbarg-trudinger:page-0096}
The adjoint of a bounded operator $T:\Hspace\to\Hspace$ is the bounded
operator $T^*$ determined by
\dcref{ch5:5.12}\group{chapter-5}\source{gilbarg-trudinger:page-0096}
...
\begin{lemma}\label{gt.lem5.9}\dcref{ch5:5.9}\group{chapter-5}\source{gilbarg-trudinger:page-0096}
...
\begin{lemma}\label{gt.lem5.10}\dcref{ch5:5.10}\group{chapter-5}\source{gilbarg-trudinger:page-0096}
...
\begin{theorem}[Hilbert-space Fredholm alternative]\label{gt.thm5.11}\dcref{ch5:5.11}\group{chapter-5}\source{gilbarg-trudinger:page-0096,page-0097}
...
\dcref{ch5:5.13}\group{chapter-5}\source{gilbarg-trudinger:page-0096,page-0097}
...
\begin{definition}\label{gt.def5.10.weak-convergence}\dcref{ch5:weak-convergence}\group{chapter-5}\source{gilbarg-trudinger:page-0097}
...
\begin{theorem}[Weak sequential compactness]\label{gt.thm5.12}\dcref{ch5:5.12}\group{chapter-5}\source{gilbarg-trudinger:page-0097}
