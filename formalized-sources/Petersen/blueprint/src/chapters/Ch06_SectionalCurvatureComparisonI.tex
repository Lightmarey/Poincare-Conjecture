...
\begin{definition}[sectional curvature bounds]
  ...
  \lean{PetersenLib.HasSecBoundedBelow,PetersenLib.HasSecBoundedAbove, PetersenLib.HasSecIn,PetersenLib.HasSecPos,PetersenLib.HasSecNeg}
...
\begin{lemma}[Bonnet--Synge index inequality]
  ...
  \lean{PetersenLib.bonnetSynge_longGeodesicsNotMinimizing, PetersenLib.bonnetSynge_variation_integrand}
...
\begin{lemma}[Myers' second-variation core]
  ...
  \lean{PetersenLib.myersRicci_secondVariation_neg,PetersenLib.bonnetSynge_secondVariation_eq, PetersenLib.myers_index_core}
