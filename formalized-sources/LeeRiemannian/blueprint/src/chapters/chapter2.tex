...
$T^2=S^1\times S^1$: \lean{LeeLib.Ch02.circleMetric} is the round metric on
$S^1\subseteq\mathbb C$, \lean{LeeLib.Ch02.torusMetric} is their product
metric, and \lean{LeeLib.Ch02.torusEmbedding_preservesMetric} identifies it
...
\dcref{ch2:2.24}
\uses{ex:surfaces-of-revolution,def:warped-product,prop:warped-product-constant-one}
\begin{enumerate}
...
\leanok
\uses{prop:riemannian-submersion-metric-unique,lem:submersion-inner-congr,prop:local-section-manifold,def:riemannian-submersion,lem:bilinear-comp-of-family-smooth,lem:horizontal-lift-in-coordinates-smooth}
...
\begin{proof}
\leanok
\uses{lem:nondegenerate-subspace,lem:orthogonal-complement,prop:polarization-scalar-product}
