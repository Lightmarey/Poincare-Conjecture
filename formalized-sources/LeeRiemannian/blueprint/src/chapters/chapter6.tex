...
\dcref{ch6:6.10}
\uses{prop:gradient-characterization}
...
\dcref{ch6:6.39}
\uses{thm:gauss-lemma-submanifolds,thm:small-geodesic-ball-convex,lem:exponential-map-implies-completeness,prop:gradient-characterization,prop:fermi-coordinates-properties,thm:smooth-local-distance-function}
