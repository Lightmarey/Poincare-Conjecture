...
\lean{Riemannian.AffineConnection.curvatureFormAt,Riemannian.AffineConnection.curvature_apply_congr,Riemannian.AffineConnection.isAlgCurvatureForm_curvatureFormAt,Riemannian.leviCivita_curvatureFormAt_chartFrame,Riemannian.leviCivita_curvature_chartFrame_expansion}
\leanok
  \dcref{ch4:2.6}
  \uses{rem:dc-ch2-2-3}
...
\lean{Riemannian.RiemannianMetric.metricRiesz_inner,Riemannian.RiemannianMetric.metricToDualEquiv,Riemannian.RiemannianMetric.metricToDual_apply}
\leanok
  \dcref{ch4:5.5}
