...
\lean{Riemannian.AffineConnection.cov_congr_apply_eventuallyEq_right,Riemannian.AffineConnection.cov_congr_apply_left,Riemannian.AffineConnection.cov_smulSum_apply}
\leanok
  \dcref{ch2:2.3}
