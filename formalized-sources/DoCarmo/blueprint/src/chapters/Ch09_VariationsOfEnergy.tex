...
\begin{lemma}[finite-segment assembly of the first variation]
  ...
  \dcref{ch9:2.4}
  \lean{Riemannian.Variation.hasDerivAt_dcEnergy_eq_piecewise_first_variation}
  \leanok
...
\begin{lemma}[proper smooth variations through a geodesic are stationary]
  ...
  \dcref{ch9:2.5}
  \lean{Riemannian.Variation.hasDerivAt_dcEnergy_zero_of_geodesic}
  \leanok
